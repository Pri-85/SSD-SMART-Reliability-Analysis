...
# ============================================================
# 1. MAIN EXECUTION BLOCK (Windows-safe)
# ============================================================
def main():
    ...
    # ============================================================
    # 3. FAILURE LABEL DEFINITION (industry thresholds)
    # ============================================================
    df["failure_label"] = (
    ...
    y = df_model["failure_label"].values.astype(int)
	...
	# ============================================================
	# 6. BAYESIAN MODEL (FAST ADVI VERSION)
	# ============================================================
    ...
    # ============================================================
    # 9. POSTERIOR PREDICTIVE PROBABILITIES
    # ============================================================
